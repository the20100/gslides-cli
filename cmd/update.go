...
// update self-updates the gslides binary by cloning the latest source from GitHub,
...
var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update gslides to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "gslides-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "gslides")
